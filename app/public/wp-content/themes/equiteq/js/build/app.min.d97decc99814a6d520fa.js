...
jQuery(document).ready(function($) {
  var $industryDropdown = $('#industry_dropdown');
  var $locationDropdown = $('#location_dropdown');
  ...
  function filterExperts() {
      var selectedIndustry = $industryDropdown.val();
      ...
      if (selectedIndustry !== '') {
          $filteredExperts = $filteredExperts.filter('.' + selectedIndustry);
      }
      if (selectedLocation !== '') {
          $filteredExperts = $filteredExperts.filter('.' + selectedLocation);
      }
      $filteredExperts.fadeIn();
  }
});
...
window.addEventListener("load", function() {
  ...
  $(window).on("load scroll resize orientationchange", function() {
      if ($(this).scrollTop() > 100) {
          $("[id^=custom_header]").addClass("sticky");
      } else {
          $("[id^=custom_header]").removeClass("sticky");
      }
